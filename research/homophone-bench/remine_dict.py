...
Preserves old data: writes dictionary-v7-remined.tsv (never overwrites the source).
...
def main():
    ...
    out = open("dictionary-v7-remined.tsv", "w", encoding="utf-8")
    ...
    out.close()
    print(f"\nremined -> dictionary-v7-remined.tsv")
